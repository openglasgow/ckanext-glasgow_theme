...
# class LicenseGlasgowOpenGovernment(DefaultLicense):
    domain_content = True
    id = "gcc-gogl"
    # CS: bad_spelling ignore
    url = "http://glasgow.gov.uk/gogl"

    @property
    def title(self):
        # CS: bad_spelling ignore
        return _("Glasgow Open Government Licence (GOGL)")
